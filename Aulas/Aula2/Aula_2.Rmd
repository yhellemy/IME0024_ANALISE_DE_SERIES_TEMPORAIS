---
title: "Aula 2 - Introdução aos processos estocásticos"
subtitle: "Material baseado no livro Análise de Séries Temporais (Morettin e Toloi, 2004)"
...
---
<img src="Aula_2_files/figure-html/Fig1.png" width="80%" align="center" />

##Processo estocástico interpretado como uma família de variáveis aleatórias (Morettin & Toloi, 2004, p. 22) 

---
<img src="Aula_2_files/figure-html/Fig2.jpeg" width="80%" align="center" />
...
Dizemos que $\left\{ \epsilon_t, t \in \mathcal{Z}\right\}$ é um ruído branco se as v.a $\epsilon_t$ são não correlacionadas, isto é, $Cov\left\{ \epsilon_t, \epsilon_s \right\} = 0, t \neq s.$
...
em que $\epsilon_t$ é um ruído branco. Vamos assumir uma condição inicial $X_0 = 0.$

* Calcule, $E[X_t]$, $Var[X_t]$ e discuta se o processo é estacionário de segunda ordem.
